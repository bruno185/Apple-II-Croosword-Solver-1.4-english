...
*   crossword solver   * 
************************
* Purpose : make search in a 279496 english words list.
...
indexlength equ $221F   ; = lengh of uncompressed index file + 1
*
********************  memory org.  ***********************
...
noincp1
        ;cmp #>indexlength  + #$20
        lda ptr1+1
        cmp #$22+#$20        ; hi byte of indexlength ($22) + $20 (hi b. of bmp1)
        bne loopcount
        lda ptr1
        cmp #<indexlength
        bne loopcount
...
ni      inc ptr2
        ...
        inc ptr2+1
ni2     lda ptr1+1
        cmp #$22+#$20   ; area is $221F long and strats at $2000
        bne andloop
        lda ptr1
        cmp #<indexlength
        bne andloop
...
patlib          str 'Pattern : '
seplib          str ' : '
titlelib        asc ' C R O S S W ? R D   S O L V E R (v. 1.4 - English)'
                hex 00
